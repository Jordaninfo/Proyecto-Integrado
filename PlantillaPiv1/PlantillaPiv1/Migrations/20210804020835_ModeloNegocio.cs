        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Gigas = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroDeContacto = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Asesores_Departamentos_DepartamentoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ContratoId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NombrePlanPlanId = table.Column<int>(type: "int", nullable: true),
                    FechaDeActivacion = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contratos_Asesores_AsesorId",
                        column: x => x.AsesorId,
                        principalTable: "Asesores",
                        principalColumn: "AsesorId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Contratos_Planes_NombrePlanPlanId",
                        column: x => x.NombrePlanPlanId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Asesores_DepartamentoId",
                table: "Asesores",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contratos_AsesorId",
                table: "Contratos",
                column: "AsesorId");

            migrationBuilder.CreateIndex(
                name: "IX_Contratos_NombrePlanPlanId",
                table: "Contratos",
                column: "NombrePlanPlanId");
        }
